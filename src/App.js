...
class App extends Component {
    ...
    this.setState(
      {
        ...
        activePrice: Price,
        activeProducerList: ProducerSet
      },
      () => {
        let pListAsString = "";
        this.state.activeProducerList.forEach(p => {
          pListAsString += p + ":";
        });
        getToysBySearchTermAndFilter(
  ...
  getFilteredByPrice = price => {
    this.getSearchedWithFilters(
      this.state.activeSearchTerm,
      price,
      this.state.activeProducerList,
      0
    );
  };
          ...
          <Switch>
            <Route
              ...
              render={props => (
                <Content
                  {...props}
                  getSearched={this.getFilteredWithSearchTerm}
                  toys={toyListToRender}
                  getFilteredByPrice={this.getFilteredByPrice}
                  producers={this.state.producers}
                  getFilteredByProducer={this.getFilteredByProducer}
